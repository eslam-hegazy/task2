...
import 'package:task2/Auth/Ui/forget_pass/pin_login.dart';
import 'package:task2/Auth/Widgets/button_start.dart';
import 'package:task2/Auth/Widgets/register_logo.dart';

import '../pincode.dart';

class send_phone extends StatefulWidget {
  @override
  _send_phoneState createState() => _send_phoneState();
}

class _send_phoneState extends State<send_phone> {
